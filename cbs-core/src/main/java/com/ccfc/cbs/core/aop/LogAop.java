package com.ccfc.cbs.core.aop;

import com.ccfc.cbs.bean.core.BussinessLog;
import com.ccfc.cbs.core.log.LogManager;
import com.ccfc.cbs.core.log.LogTaskFactory;
import com.ccfc.cbs.security.JwtUtil;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.ccfc.cbs.bean.core.BussinessLog)")
