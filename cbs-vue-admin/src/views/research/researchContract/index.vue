<template>
    <div class="app-container">
            ...
            <el-row>
                <el-col :span="24">
                    <el-button type="success" size="mini" icon="el-icon-plus" @click.native="add"
                               v-permission="['/research/researchcontract/add']">{{ $t('button.add') }}
                    </el-button>
                    <el-button type="primary" size="mini" icon="el-icon-edit" @click.native="edit"
                               v-permission="['/research/researchcontract/update']">{{ $t('button.edit') }}
                    </el-button>
                    <el-button type="danger" size="mini" icon="el-icon-delete" @click.native="remove"
                               v-permission="['/research/researchcontract/delete']">{{ $t('button.delete') }}
                    </el-button>
                </el-col>
            </el-row>
        </div>
        ...
        <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row
            ...
            <el-table-column label="图表化方式">
                <template slot-scope="scope">
                    {{scope.row.tableDisplay}}
                </template>
            </el-table-column>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="交易所">
                            <el-input v-model="form.marketNo" minlength=1></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="表中文名">
                            <el-input v-model="form.tableNameCh" minlength=1></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="图表化方式">
                            <el-input v-model="form.tableDisplay" minlength=1></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-form-item>
...
<script src="./researchContract.js"></script>
