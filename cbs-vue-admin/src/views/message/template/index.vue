        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="发送条件">
                            <el-input v-model="form.cond" :disabled="true" minlength=1></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="发送器">
