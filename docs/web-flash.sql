...
-- ----------------------------
INSERT INTO `t_sys_operation_log` VALUES ('1', 'ArticleMgrController', '2019-05-10 13:22:49', '添加参数', '业务日志', '参数名称=system.app.name', 'upload', '成功', '1');
INSERT INTO `t_sys_operation_log` VALUES ('2', 'ArticleMgrController', '2019-06-10 13:31:09', '修改参数', '业务日志', '参数名称=system.app.name', 'upload', '成功', '1');
INSERT INTO `t_sys_operation_log` VALUES ('3', 'ArticleMgrController', '2019-07-10 13:22:49', '编辑文章', '业务日志', '参数名称=system.app.name', 'upload', '成功', '1');
INSERT INTO `t_sys_operation_log` VALUES ('4', 'ArticleMgrController', '2019-08-10 13:31:09', '编辑栏目', '业务日志', '参数名称=system.app.name', 'upload', '成功', '1');
...
CREATE TABLE `t_client_reserveopenclient` (
    ...
    `business_date` INT DEFAULT NULL COMMENT '业务日期',
    ...
    `dept_id` INT DEFAULT NULL COMMENT '部门序号',
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='预约开户信息';

-- ----------------------------
-- Records of t_client_reserveopenclient
-- ----------------------------