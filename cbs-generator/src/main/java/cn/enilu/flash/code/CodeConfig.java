...
public class CodeConfig {
    private String entityModel = "cbs-core";
    private String daoModel = "cbs-core";
    private String serviceModel = "cbs-core";
    private String controllerModel = "cbs-api";
    private String viewModel = "cbs-vue-admin";
