import wxGoodVoiceApi from '@/api/cms/wxGoodVoice'
...
export default {
    ...
    methods: {
        ...
        fetchData() {
            ...
            wxGoodVoiceApi.getList(this.listQuery).then(response => {
        ...
        save() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    if (formData.id) {
                        wxGoodVoiceApi.update(formData).then(response => {
                            this.$message({
                        ...
                        wxGoodVoiceApi.add(formData).then(response => {
                            this.$message({
                                message: this.$t('common.optionSuccess'),
                                type: 'success'
                            })
        ...
        remove() {
            if (this.checkSel()) {
                ...
                this.$confirm(this.$t('common.deleteConfirm'), this.$t('common.tooltip'), {
                    ...
                    wxGoodVoiceApi.remove(id).then(response => {
                        this.$message({
                            message: this.$t('common.optionSuccess'),
                            type: 'success'
                        })
