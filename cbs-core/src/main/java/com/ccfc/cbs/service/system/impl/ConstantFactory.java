...
import com.ccfc.cbs.utils.cache.TimeCacheMap;
...
public class ConstantFactory implements IConstantFactory {
     ...
     */
    @Override
    public String getWhetherName(Boolean isTrue) {
        String str = isTrue ? "1" : "0";
        return getDictsByName("是否", str);
    }
