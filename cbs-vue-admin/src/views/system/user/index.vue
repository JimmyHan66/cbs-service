        ...
        <div class="block">
            ...
            <el-row>
                <el-col :span="24">
                    ...
                    <el-button type="info" size="mini" icon="el-icon-s-operation" @click.native="openRole"
                               v-permission="['/mgr/setRole']">角色分配
                    </el-button>
                </el-col>
            </el-row>
        </div>
                    ...
                    <el-table-column label="操作" min-width="150px">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" size="mini" icon="el-icon-delete"
                                       @click.native="removeItem(scope.row)" v-permission="['/mgr/delete']">
                                {{$t('button.delete') }}
                            </el-button>
                            <el-button type="text" size="mini" icon="el-icon-s-operation"
                                       @click.native="openRoleItem(scope.row)" v-permission="['/mgr/setRole']">角色分配
                            </el-button>
                        </template>
                    </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="120px" label-position="right">
                ...
                <el-form-item>
                    ...
                    <el-button @click.native="formVisible = false;tip = ''">{{ $t('button.cancel') }}</el-button>
